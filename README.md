...
### ⏱️ Сжатие-разжатие времени
- **Применить трансформацию**: `Ctrl+T` (между метками A и B)
- **Тонкомпенсация**: Сохранение высоты тона при изменении длительности
- **Undo/Redo**: `Ctrl+Z` / `Ctrl+Y` для отмены/повтора
...
- [Статус библиотек Mixxx](MARKDOWN/MIXXX_LIBRARIES_STATUS.md) - информация о подключении библиотек qm-dsp
- [Функция Time Stretch](MARKDOWN/TIMESTRETCH_FEATURE.md) - сжатие-разжатие времени с тонкомпенсацией
