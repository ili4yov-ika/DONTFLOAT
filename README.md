...
- **🆕 Чёткое отображение ударных инструментов**:
  - Автоматическая детекция и классификация ударных
  - Цветовое кодирование по типам (kick, snare, hi-hat, crash, ride, tom)
  - Размерное кодирование по энергии ударных
...
- **Маркеры ударных**: `Ctrl+M`
- **Спектрограмма**: `Ctrl+S`
- **Энергия ударных**: `Ctrl+E`
