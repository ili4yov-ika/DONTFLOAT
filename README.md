...
- Piano roll с метками нот и пиками волны
- Синхронизированная каретка воспроизведения (в одной вертикали с волной)
- Тактовая сетка, zoom и прокрутка синхронны с `WaveformView`
