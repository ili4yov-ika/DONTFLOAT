...
private:
    ...
    /**
     * Отдаёт пересчитанный звук в модель ARA — иначе хост играет исходник.
     *
     * Под ARA дорожку выдаёт наш рендерер, а выход плагина хост не слушает:
     * без этого шага растяжение было видно на волне, но не слышно.
     */
