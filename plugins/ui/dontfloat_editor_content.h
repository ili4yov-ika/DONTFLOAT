...
public:
    ...
    /**
     * Просит DAW начать или остановить воспроизведение.
     *
     * Под ARA дорожку играет хост, а не плагин: своего транспорта у плагина
     * нет. Кнопка воспроизведения поэтому управляет DAW — тогда слышно ровно
     * то, что видно, и каретки не расходятся. Вне ARA возвращает false, и
