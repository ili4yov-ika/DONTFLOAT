...
- **S**: разрез ноты под кареткой воспроизведения; пока фокус на пианоролле, клавиша уходит сюда, а не в «Стоп» (настраивается в диалоге горячих клавиш, id `SplitNote`)
