...
- **Сообщения в строке состояния** после смены языка: для `Language: English` в `ru_RU.ts` перевод должен совпадать с источником (`Language: English`), не локализовать как «Язык: английский»; строка `Язык: Русский` остаётся как в источнике для русской локали
