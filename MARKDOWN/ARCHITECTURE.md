...
### PitchGridWidget
- **Роль**: Piano roll и миниатюра волны под основным таймлайном
- **Статус**: **Скрыта по умолчанию**; `Ctrl+G` или меню **Вид**; `QSettings` → `pitchGridVisible`
- **Движок**: `GiadaPitchGridEngine` — viewport, пики, beat grid, snap (адаптация Giada)
- **Ответственность**:
  - Синхронизация с WaveformView (zoom, offset, каретка, BPM, длина таймлайна)
  - Отрисовка piano roll, пиков, тактовой сетки, каретки
  - Подписи нот (overlay справа); таймлайн на полную ширину виджета
