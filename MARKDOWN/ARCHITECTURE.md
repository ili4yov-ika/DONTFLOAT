...
### MarkerEngine
- **Роль**: Данные и UI меток для сжатия/растяжения
...
### TimeStretchCommand
- **Роль**: Команды undo/redo для операций сжатия-растяжения по меткам
...
### TimeStretchCommand
- Применение сжатия/растяжения по меткам (Ctrl+T)
