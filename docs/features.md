...
### Описание
Система меток для **визуализации** будущего сжатия/растяжения участков аудио и последующего применения эффекта с тонкомпенсацией. Метки отображаются как белые вертикальные линии с ромбиками в центре.
...
- **Коэффициенты**: Тонкие горизонтальные линии между метками с отображением коэффициента сжатия/растяжения
